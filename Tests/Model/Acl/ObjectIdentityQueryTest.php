...
class ObjectIdentityQueryTest extends TestCase
{
    ...
    {
        $aclObj = new ObjectIdentity(1, 'Propel\Bundle\PropelAclBundle\Tests\Fixtures\Model\Book');
        ...
        // Change the entity.
        $aclObj = new ObjectIdentity(2, 'Propel\Bundle\PropelAclBundle\Tests\Fixtures\Model\Book');
        $result = ObjectIdentityQuery::create()->filterByAclObjectIdentity($aclObj, $this->con)->find($this->con);
        $this->assertCount(0, $result);
    }
    ...
    public function testFindOneByAclObjectIdentity()
    {
        ...
        $result = ObjectIdentityQuery::create()->findOneByAclObjectIdentity($aclObj, $this->con);
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Model\Acl\ObjectIdentity', $result);
    ...
    public function testFindChildren()
    {
        ...
        $result = ObjectIdentityQuery::create()->findChildren($objIdentity, $this->con);
        $this->assertCount(1, $result);
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Model\Acl\ObjectIdentity', $result->getFirst());
