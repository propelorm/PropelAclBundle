...
use Propel\Bundle\PropelAclBundle\Tests\Fixtures\Acl\ArrayCache as AclCache;
...
class MutableAclProviderTest extends TestCase
{
    public function testCreateAcl()
    {
        ...
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\MutableAcl', $acl);
    ...
    public function testUpdateAclCreatesInsertedAces()
    {
        ...
        $entry = $objAces[0];
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\Entry', $entry);
        ...
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\FieldEntry', $entry);
