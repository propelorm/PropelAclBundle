...
use Propel\Bundle\PropelAclBundle\Security\Acl\Domain\FieldEntry;
...
class FieldEntryTest extends TestCase
{
    ...
    public function testSerializeUnserialize(FieldEntry $entry)
    {
        ...
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\FieldEntry', $unserialized);
