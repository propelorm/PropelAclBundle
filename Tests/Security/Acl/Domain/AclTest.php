...
class AclTest extends TestCase
{
    public function testConstructorInvalidCollection()
    {
        ...
        $collection->setModel('Propel\Bundle\PropelAclBundle\Model\Acl\AclClass');
    ...
    public function testConstructorWithAces()
    {
        ...
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\Entry', $classAces[0]);
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\Entry', $objectAces[0]);
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\FieldEntry', $classFieldAces[0]);
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\FieldEntry', $objectFieldAces[0]);
