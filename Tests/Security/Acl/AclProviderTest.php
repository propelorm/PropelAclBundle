...
use Propel\Bundle\PropelAclBundle\Security\Acl\AclProvider;
...
class AclProviderTest extends TestCase
{
    ...
    public function testFindAclWithEntries()
    {
        ...
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\Acl', $acl);
    ...
    public function testFindAclWithParent()
    {
        ...
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\Acl', $acl);
        $this->assertInstanceOf('Propel\Bundle\PropelAclBundle\Security\Acl\Domain\Acl', $parent);
